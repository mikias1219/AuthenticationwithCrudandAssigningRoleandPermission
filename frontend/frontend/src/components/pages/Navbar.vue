<template>
  <aside class="flex flex-col h-screen w-72 bg-white border-r border-gray-200 font-sans sticky top-0">
    <!-- 1. Header Logo Area -->
    <!-- <div class="px-6 py-6 flex items-center gap-3">
      <div class="relative flex items-center justify-center size-10 rounded-full bg-red-600 text-white overflow-hidden shrink-0">
         <Building2 class="size-6" />
      </div>

      <span class="font-bold text-lg text-gray-900 leading-tight">Century<br/>Real Estate</span>
    </div> -->

    <!-- 2. Company Info (Static Placeholder to match design) -->
    <div class="px-4 mb-6">
      <div class="group flex items-center justify-between gap-2 p-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
    ...
    <div class="p-4 border-t border-gray-200">
      <div class="flex items-center justify-between gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors group">
         <div class="flex items-center gap-3 overflow-hidden">
            ...
            <div class="flex flex-col truncate">
                <span class="text-sm font-semibold text-gray-900 truncate">Century Admin</span>
                <span class="text-xs text-gray-500 truncate">admin@century.com</span>
            </div>
         </div>
